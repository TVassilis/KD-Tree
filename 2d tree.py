...
print("2D Tree build: ", elapsed_time)
...
elapsed_time = time.time() - start_time
print("2D Tree Search: ", elapsed_time)

print()
print()

start_time = time.time()
print("Searhing point (601399, 249898)")
searchNode = search((601399, 249898), KD, 0)
print(searchNode)
elapsed_time = time.time() - start_time
print("2D Tree Search: ", elapsed_time)
...
print()
start_time = time.time()
print("Inserting point (602566,356878)")
insertNode = insert((602566,356878), KD, 0)
elapsed_time = time.time() - start_time
print("2D insert: ", elapsed_time)
print("Searching point: (602566,356878)")
print(search((602566,356878), KD, 0))

print()
start_time = time.time()
print("Deleting point (602566,356878)")
delete((602566,356878), KD, 0)
elapsed_time = time.time() - start_time
print("2D delete node: ", elapsed_time)
print("Searchingpont: (602566,356878)")
print(search((602566,356878), KD, 0))
